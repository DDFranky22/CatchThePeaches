...
public class IndieQuiltCommunicator : MonoBehaviour
{
		...
		//Feel free to temporarily change this variable's value as you need for standalone builds / testing.
		...
		//This will be automatically set to true if the Player chooses to activate photosensitive-safe mode from IndieQuilt main options.
		public bool colorblind = false;
		//This will also be set to true under the same situation, but for colorblind mode.
